/*
 * @Author: taoshiwei
 * @Date: 2019-04-09 14:38:13
 * @Last Modified by:   taoshiwei
 * @Last Modified time: 2019-04-09 14:38:13
 *
 * 城市 地区
 */
...
const datas = [
  ...
  {
    city: '唐山市',
    area: ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市']
  },
  {
    city: '秦皇岛市',
  ...
  {
    city: '张家口市',
    area: ['桥东区', '桥西区', '宣化区', '下花园区', '万全区', '崇礼区', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '怀来县', '涿鹿县', '赤城县']
  },
  {
    city: '承德市',
  ...
  {
    city: '衡水市',
    area: ['桃城区', '冀州区', '枣强县', '武邑县', '武强县', '饶阳县', '安平县', '故城县', '景县', '阜城县', '深州市']
  },
  {
    city: '定州市',
    area: ['定州市', '辛集市']
  ...
  {
    city: '鄂尔多斯市',
    area: ['东胜区', '康巴什区', '达拉特旗', '准格尔旗', '鄂托克前旗', '鄂托克旗', '杭锦旗', '乌审旗', '伊金霍洛旗']
  },
  {
    city: '呼伦贝尔市',
    area: [
  ...
  {
    city: '沈阳市',
    area: ['和平区', '沈河区', '大东区', '皇姑区', '铁西区', '苏家屯区', '浑南区', '沈北新区', '于洪区', '辽中区', '康平县', '法库县', '新民市']
  },
  {
    city: '大连市',
    area: ['中山区', '西岗区', '沙河口区', '甘井子区', '旅顺口区', '金州区', '普兰店区', '长海县', '瓦房店市', '庄河市']
  },
  {
    city: '鞍山市',
  ...
  {
    city: '长春市',
    area: ['南关区', '宽城区', '朝阳区', '二道区', '绿园区', '双阳区', '九台区', '农安县', '榆树市', '德惠市']
  },
  {
    city: '吉林市',
  ...
  {
    city: '松原市',
    area: ['宁江区', '前郭尔罗斯蒙古族自治县', '长岭县', '乾安县', '扶余市']
  },
  {
    city: '白城市',
  ...
  {
    city: '哈尔滨市',
    area: ['道里区', '南岗区', '道外区', '平房区', '松北区', '香坊区', '呼兰区', '阿城区', '双城区', '依兰县', '方正县', '宾县', '巴彦县', '木兰县', '通河县', '延寿县', '尚志市', '五常市']
  },
  {
    city: '齐齐哈尔市',
    area: ['龙沙区', '建华区', '铁锋区', '昂昂溪区', '富拉尔基区', '碾子山区', '梅里斯达斡尔族区', '龙江县', '依安县', '泰来县', '甘南县', '富裕县', '克山县', '克东县', '拜泉县', '讷河市']
  },
  {
    city: '鸡西市',
  ...
  {
    city: '佳木斯市',
    area: ['向阳区', '前进区', '东风区', '郊区', '桦南县', '桦川县', '汤原县', '同江市', '富锦市', '抚远市']
  },
  {
    city: '七台河市',
  ...
  {
    city: '牡丹江市',
    area: ['东安区', '阳明区', '爱民区', '西安区', '林口县', '绥芬河市', '海林市', '宁安市', '穆棱市', '东宁市']
  },
  {
    city: '黑河市',
  ...
  {
    city: '南京市',
    area: ['玄武区', '秦淮区', '建邺区', '鼓楼区', '浦口区', '栖霞区', '雨花台区', '江宁区', '六合区', '溧水区', '高淳区']
  },
  {
    city: '无锡市',
    area: ['锡山区', '惠山区', '滨湖区', '梁溪区', '新吴区', '江阴市', '宜兴市']
  },
  {
    city: '徐州市',
    area: ['鼓楼区', '云龙区', '贾汪区', '泉山区', '铜山区', '丰县', '沛县', '睢宁县', '新沂市', '邳州市']
  },
  {
    city: '常州市',
  ...
  {
    city: '苏州市',
    area: ['虎丘区', '吴中区', '相城区', '姑苏区', '吴江区', '常熟市', '张家港市', '昆山市', '太仓市']
  },
  {
    city: '南通市',
    area: ['崇川区', '港闸区', '通州区', '海安县', '如东县', '启东市', '如皋市', '海门市']
  },
  {
    city: '连云港市',
    area: ['连云区', '海州区', '赣榆区', '东海县', '灌云县', '灌南县']
  },
  {
    city: '淮安市',
  ...
  {
    city: '盐城市',
    area: ['亭湖区', '盐都区', '大丰区', '响水县', '滨海县', '阜宁县', '射阳县', '建湖县', '东台市']
  },
  {
    city: '扬州市',
    area: ['广陵区', '邗江区', '江都区', '宝应县', '仪征市', '高邮市']
  },
  {
    city: '镇江市',
  ...
  {
    city: '杭州市',
    area: ['上城区', '下城区', '江干区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '富阳区', '桐庐县', '淳安县', '建德市', '临安市']
  },
  {
    city: '宁波市',
  ...
  {
    city: '温州市',
    area: ['鹿城区', '龙湾区', '瓯海区', '洞头区', '永嘉县', '平阳县', '苍南县', '文成县', '泰顺县', '瑞安市', '乐清市']
  },
  {
    city: '嘉兴市',
  ...
  {
    city: '合肥市',
    area: ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县', '庐江县', '巢湖市']
  },
  {
    city: '芜湖市',
    area: ['镜湖区', '弋江区', '鸠江区', '三山区', '芜湖县', '繁昌县', '南陵县', '无为县']
  },
  {
    city: '蚌埠市',
  ...
  {
    city: '淮南市',
    area: ['大通区', '田家庵区', '谢家集区', '八公山区', '潘集区', '凤台县', '寿县']
  },
  {
    city: '马鞍山市',
  ...
  {
    city: '安庆市',
    area: ['迎江区', '大观区', '宜秀区', '怀宁县', '潜山县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市']
  },
  {
    city: '黄山市',
  ...
  {
    city: '六安市',
    area: ['金安区', '裕安区', '叶集区', '霍邱县', '舒城县', '金寨县', '霍山县']
  },
  {
    city: '亳州市',
  ...
  {
    city: '泉州市',
    area: ['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '金门县', '石狮市', '晋江市', '南安市']
  },
  {
    city: '漳州市',
  ...
  {
    city: '南平市',
    area: ['延平区', '建阳区', '顺昌县', '浦城县', '光泽县', '松溪县', '政和县', '邵武市', '武夷山市', '建瓯市']
  },
  {
    city: '龙岩市',
    area: ['新罗区', '永定区', '长汀县', '上杭县', '武平县', '连城县', '漳平市']
  },
  {
    city: '宁德市',
  ...
  {
    city: '南昌市',
    area: ['东湖区', '西湖区', '青云谱区', '湾里区', '青山湖区', '新建区', '南昌县', '安义县', '进贤县']
  },
  {
    city: '景德镇市',
  ...
  {
    city: '九江市',
    area: ['濂溪区', '浔阳区', '九江县', '武宁县', '修水县', '永修县', '德安县', '都昌县', '湖口县', '彭泽县', '瑞昌市', '共青城市', '庐山市']
  },
  {
    city: '新余市',
    area: ['渝水区', '分宜县']
  ...
  {
    city: '赣州市',
    area: ['章贡区', '南康区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市']
  },
  {
    city: '吉安市',
  ...
  {
    city: '抚州市',
    area: ['临川区', '南城县', '黎川县', '南丰县', '崇仁县', '乐安县', '宜黄县', '金溪县', '资溪县', '东乡区', '广昌县']
  },
  {
    city: '上饶市',
    area: ['信州区', '广丰区', '上饶县', '玉山县', '铅山县', '横峰县', '弋阳县', '余干县', '鄱阳县', '万年县', '婺源县', '德兴市']
  },
  {
    city: '济南市',
  ...
  {
    city: '青岛市',
    area: ['市南区', '市北区', '黄岛区', '崂山区', '李沧区', '城阳区', '胶州市', '即墨市', '平度市', '莱西市']
  },
  {
    city: '淄博市',
  ...
  {
    city: '滨州市',
    area: ['滨城区', '沾化区', '惠民县', '阳信县', '无棣县', '博兴县', '邹平县']
  },
  {
    city: '菏泽市',
    area: ['牡丹区', '定陶区', '曹县', '单县', '成武县', '巨野县', '郓城县', '鄄城县', '东明县']
  },
  {
    city: '郑州市',
  ...
  {
    city: '开封市',
    area: ['龙亭区', '顺河回族区', '鼓楼区', '禹王台区', '金明区', '祥符区', '杞县', '通许县', '尉氏县', '兰考县']
  },
  {
    city: '洛阳市',
  ...
  {
    city: '襄阳市',
    area: ['襄城区', '樊城区', '襄州区', '南漳县', '谷城县', '保康县', '老河口市', '枣阳市', '宜城市']
  },
  {
    city: '鄂州市',
    area: ['梁子湖区', '华容区', '鄂城区']
  ...
  {
    city: '神农架林区',
    area: ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇', '九湖镇', '宋洛乡', '下谷坪土家族乡']
  },
  {
    city: '长沙市',
    area: ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '望城区', '长沙县', '宁乡县', '浏阳市']
  },
  {
    city: '株洲市',
  ...
  {
    city: '广州市',
    area: ['荔湾区', '越秀区', '海珠区', '天河区', '白云区', '黄埔区', '番禺区', '花都区', '南沙区', '从化区', '增城区']
  },
  {
    city: '韶关市',
  ...
  {
    city: '清远市',
    area: ['清城区', '清新区', '佛冈县', '阳山县', '连山壮族瑶族自治县', '连南瑶族自治县', '英德市', '连州市']
  },
  {
    city: '东莞市',
    area: [
  ...
  {
    city: '南宁市',
    area: ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '武鸣区', '隆安县', '马山县', '上林县', '宾阳县', '横县']
  },
  {
    city: '柳州市',
    area: ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江区', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县']
  },
  {
    city: '桂林市',
    area: ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县', '平乐县', '荔浦县', '恭城瑶族自治县']
  },
  {
    city: '梧州市',
    area: ['万秀区', '长洲区', '龙圩区', '苍梧县', '藤县', '蒙山县', '岑溪市']
  },
  {
    city: '北海市',
  ...
  {
    city: '百色市',
    area: ['右江区', '田阳县', '田东县', '平果县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林各族自治县', '靖西市']
  },
  {
    city: '贺州市',
  ...
  {
    city: '绵阳市',
    area: ['涪城区', '游仙区', '安州区', '三台县', '盐亭县', '梓潼县', '北川羌族自治县', '平武县', '江油市']
  },
  {
    city: '广元市',
    area: ['利州区', '昭化区', '朝天区', '旺苍县', '青川县', '剑阁县', '苍溪县']
  },
  {
    city: '遂宁市',
  ...
  {
    city: '宜宾市',
    area: ['翠屏区', '南溪区', '宜宾县', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县']
  },
  {
    city: '广安市',
  ...
  {
    city: '达州市',
    area: ['通川区', '达川区', '宣汉县', '开江县', '大竹县', '渠县', '万源市']
  },
  {
    city: '雅安市',
    area: ['雨城区', '名山区', '荥经县', '汉源县', '石棉县', '天全县', '芦山县', '宝兴县']
  },
  {
    city: '巴中市',
    area: ['巴州区', '恩阳区', '通江县', '南江县', '平昌县']
  },
  {
    city: '资阳市',
    area: ['雁江区', '安岳县', '乐至县']
  ...
  {
    city: '贵阳市',
    area: ['南明区', '云岩区', '花溪区', '乌当区', '白云区', '观山湖区', '开阳县', '息烽县', '修文县', '清镇市']
  },
  {
    city: '六盘水市',
  ...
  {
    city: '遵义市',
    area: ['红花岗区', '汇川区', '播州区', '桐梓县', '绥阳县', '正安县', '道真仡佬族苗族自治县', '务川仡佬族苗族自治县', '凤冈县', '湄潭县', '余庆县', '习水县', '赤水市', '仁怀市']
  },
  {
    city: '安顺市',
    area: ['西秀区', '平坝区', '普定县', '镇宁布依族苗族自治县', '关岭布依族苗族自治县', '紫云苗族布依族自治县']
  },
  {
    city: '毕节市',
    area: ['七星关区', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县']
  },
  {
    city: '铜仁市',
    area: ['碧江区', '万山区', '江口县', '玉屏侗族自治县', '石阡县', '思南县', '印江土家族苗族自治县', '德江县', '沿河土家族自治县', '松桃苗族自治县']
  },
  {
    city: '黔西南布依族苗族自治州',
  ...
  {
    city: '昆明市',
    area: ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡区', '晋宁县', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县', '寻甸回族彝族自治县', '安宁市']
  },
  {
    city: '曲靖市',
    area: ['麒麟区', '沾益区', '马龙县', '陆良县', '师宗县', '罗平县', '富源县', '会泽县', '宣威市']
  },
  {
    city: '玉溪市',
  ...
  {
    city: '拉萨市',
    area: ['城关区', '堆龙德庆区', '林周县', '当雄县', '尼木县', '曲水县', '达孜县', '墨竹工卡县']
  },
  {
    city: '日喀则市',
  ...
  {
    city: '山南市',
    area: ['乃东区', '扎囊县', '贡嘎县', '桑日县', '琼结县', '曲松县', '措美县', '洛扎县', '加查县', '隆子县', '错那县', '浪卡子县']
  },
  {
    city: '那曲地区',
  ...
  {
    city: '西安市',
    area: ['新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '高陵区', '蓝田县', '周至县', '户县']
  },
  {
    city: '铜川市',
  ...
  {
    city: '延安市',
    area: ['宝塔区', '安塞区', '延长县', '延川县', '子长县', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县']
  },
  {
    city: '汉中市',
  ...
  {
    city: '榆林市',
    area: ['榆阳区', '横山区', '神木县', '府谷县', '靖边县', '定边县', '绥德县', '米脂县', '佳县', '吴堡县', '清涧县', '子洲县']
  },
  {
    city: '安康市',
